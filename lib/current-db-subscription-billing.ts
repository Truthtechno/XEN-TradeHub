...
export class CurrentDbSubscriptionBillingService {
  /**
  ...
  async createSubscription(
    ...
    try {
      ...
      // Use the existing fields that are available
      const existingSubscription = await prisma.subscription.findFirst({
        where: {
          userId,
          // Use status field instead of active
          status: 'ACTIVE'
        }
      })
      ...
      // Create subscription using the required fields
...
export const currentDbSubscriptionBilling = new CurrentDbSubscriptionBillingService()
