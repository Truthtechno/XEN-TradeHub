...
export class WorkingSubscriptionBillingService {
  /**
  ...
  async createSubscription(
    ...
    try {
      ...
      // Create subscription using the existing schema
...
export const workingSubscriptionBilling = new WorkingSubscriptionBillingService()
