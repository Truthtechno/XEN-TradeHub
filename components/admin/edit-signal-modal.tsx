...
import { X, Save, TrendingUp, TrendingDown, Target, DollarSign, AlertTriangle, CheckCircle } from 'lucide-react'
...
export default function EditSignalModal({ isOpen, onClose, onSuccess, signal }: EditSignalModalProps) {
  ...
  // Populate form when signal changes
  useEffect(() => {
    if (signal) {
      setFormData({
        title: signal.title || '',
        ...
        notes: signal.notes || '',
        visibility: signal.visibility === 'PUBLIC' ? 'EVERYONE' : 
                   signal.visibility === 'SUBSCRIBERS_ONLY' ? 'PREMIUM' : 'DRAFT',
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg max-w-4xl w-full max-h-[95vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-center p-6 border-b border-gray-200 dark:border-gray-700">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Edit Trading Signal</h2>
            <p className="text-gray-600 dark:text-gray-400">Update the trading signal details</p>
          </div>
          <Button
            variant="ghost"
            size="sm"
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription className="text-gray-600 dark:text-gray-400">
                Update the basic details for your trading signal
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription className="text-gray-600 dark:text-gray-400">
                Update the entry, stop loss, and take profit levels
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
